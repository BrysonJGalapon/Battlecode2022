...
public class Parameters {
    ...
    public static final int MINER_RESOURCE_IDENTIFICATION_BYTECODE_LIMIT = 2500;

    public static final int MINER_RECEIVE_MESSAGE_BYTECODE_LIMIT = 800;
    public static final int BUILDER_RECEIVE_MESSAGE_BYTECODE_LIMIT = 2500;
    ...
    public static final int[] ARCHON_RESOURCE_COLLECTION_BUILD_DISTRIBUTION = new int[]{4, 0, 0, 3};
    public static final int[] ARCHON_DEFEND_BUILD_DISTRIBUTION = new int[]{1, 1, 0, 8};
    public static final int[] ARCHON_ATTACK_BUILD_DISTRIBUTION = new int[]{1, 1, 0, 8};
    ...
    public static final int[] RESOURCE_ALLOCATION_RESOURCE_COLLECTION_LEAD_DISTIBUTION = new int[]{100, 0, 0};
    public static final int[] RESOURCE_ALLOCATION_DEFEND_LEAD_DISTIBUTION = new int[]{30, 70, 0};
    ...
    public static final int[] RESOURCE_ALLOCATION_RESOURCE_COLLECTION_GOLD_DISTIBUTION = new int[]{0, 100, 0};
    public static final int[] RESOURCE_ALLOCATION_DEFEND_GOLD_DISTIBUTION = new int[]{0, 100, 0};
    public static final int[] RESOURCE_ALLOCATION_ATTACK_GOLD_DISTIBUTION = new int[]{0, 100, 0};
    public static final int[] RESOURCE_ALLOCATION_SURVIVE_GOLD_DISTIBUTION = new int[]{0, 100, 0};
    ...
    public static final int ARCHON_DEFEND_TO_ATTACK_ROBOT_COUNT_THRESHOLD = 20;
...
//    public static final int LEAD_LOCATION_MESSAGE_SHELF_LIFE = 20;
    ...
    public static final int LEAD_FARM_AMOUNT_THRESHOLD = 75;
}
